"""
gem5 Configuration: 4-Way Set-Associative Cache
...
print("=" * 60)
print("Starting 4-Way Set-Associative Cache Simulation")
print("L1 ICache: 32kB, assoc=4 | L1 DCache: 32kB, assoc=4")
